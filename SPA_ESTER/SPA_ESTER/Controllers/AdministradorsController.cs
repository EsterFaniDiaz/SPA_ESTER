...
namespace SPA_ESTER.Controllers
{
    ...
    public class AdministradorsController : Controller
    {
        ...
        {
            var administrador = db.Administrador.Include(a => a.Usuarios);
        ...
        public ActionResult Create([Bind(Include = "id_ad,nombre_ad,teléfono_ad,dirección_ad,correo_ad,id_usuario")] Administrador administrador)
        {
            ...
            ViewBag.id_usuario = new SelectList(db.Usuarios, "id_usuario", "usuario", administrador.id_usuario);
            return View(administrador);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_ad,nombre_ad,teléfono_ad,dirección_ad,correo_ad,id_usuario")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
